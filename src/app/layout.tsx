...
export const metadata: Metadata = {
  ...
  description: "Experience luxury at Grand Vista Hotel with elegant rooms, world-class amenities, fine dining, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, accommodations, spa, fine dining, business hotel, city center hotel, concierge service",
  openGraph: {
    title: "Grand Vista Hotel - Luxury Accommodations & Exceptional Service",
    description: "Experience luxury at Grand Vista Hotel with elegant rooms, world-class amenities, fine dining, and exceptional service in the heart of the city.",
